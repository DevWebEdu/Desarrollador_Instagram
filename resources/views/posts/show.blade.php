...
@section('contenido')
    ...
    <div class="container mx-auto md:flex">
        {{-- LADO DE IMAGEN Y DESCRIPCION DE PUBLICACION --}}
        <div class="md:w-1/2">
            ...
            <div class="shadow bg-white p-5 mb-5">
                @auth
                    ...
                    <form method="POST" action="{{ route('comentarios.store', ['post' => $post, 'user' => $user]) }}"
                        ...
                        @csrf
                        <div class="mb-5">
                            <label for="comentario" class="mb-2 block uppercase text-gray-500 font-bold"> Ingresa tu comentario
                            </label>
                            <textarea id="comentario" name="comentario" type="text" placeholder="Comenta aqui!!"
                ...
                <div class="bg-white shadow mb-5 max-h-96 overflow-y-auto mt-10">
                    @if ($post->comentarios->count())
                        ...
                        @endforeach
                    @else
                        <p class="p-10 text-center"> No tiene comentarios aun</p>
                    @endif
                </div>
